...
#### You have absolutely every right to use the code in this repo as your own but it would be more helpful to understand the concepts involved and why we did certain things in certain ways instead of just copying. 
